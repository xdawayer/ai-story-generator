      ...
      <section className="wrap" style={{ paddingTop: 28, paddingBottom: 24 }}>
        ...
        <div style={{ marginTop: 36, maxWidth: 760 }}>
          ...
          <p className="lead">
            ...
            them blank — and generate. You get a structured past with a wound and
            a want, not a wall of generic lore, so the character has something to
            play toward and something to hide. Add a name or homeland in the
            details field, and hit <strong>Regenerate</strong> for a new angle.
          </p>
          <p className="lead" style={{ marginTop: 16 }}>
            Keep building: turn the character into a table-ready{" "}
            <Link href="/rpg-tools/npc-generator">NPC</Link>, find them a fitting{" "}
            <Link href="/rpg-tools/dnd-name-generator">name</Link>, and save the
            result into a <Link href="/campaigns">campaign</Link> your tools
